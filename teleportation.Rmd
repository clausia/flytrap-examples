...
However, by taking advantage of two classical bits and a pair of entangled quibits, Alice can transfer her state $|\psi\rangle$ to Bob. This protocol is called teleportation because eventually Bob will have $|\psi\rangle$ and Alice will no longer have it.
...
Now Alice, according to the protocol, applies a $CNOT$ gate to her two qubits: where the target is qubit $1$ (her entangled qubit), and the control is $|\psi\rangle$ (position $0$), which is the qubit that she wants to send to Bob.
