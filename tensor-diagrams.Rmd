...
<div id="einsumindl16_A_pqrs" class="eq-elem">$${A_{ps}}^{qr}$$</div>
<div id="einsumindl16_B_tuqvr" class="eq-elem">$${B_{qr}}^{tuv}$$</div>
...
<div id="einsumindl17_A_ik" class="eq-elem">$${A_{i}}^{k}$$</div>
<div id="einsumindl17_B_jkl" class="eq-elem">$${B_{jk}}^{l}$$</div>
<div id="einsumindl17_C_il" class="eq-elem">$$C_{il}$$</div>
