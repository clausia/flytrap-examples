...
<div id="einsumindl1_A_ik" class="eq-elem">$${A_{i}}^{k}$$</div>
<div id="einsumindl1_B_kj" class="eq-elem">$${B_{k}}^{j}$$</div>
...
<div id="einsumindl2_a_i" class="eq-elem">$$a^{i}$$</div>
<div id="einsumindl2_b_i" class="eq-elem">$$b_{i}$$</div>
...
<div id="einsumindl3_T_ntk" class="eq-elem">$${T_{nt}}^{k}$$</div>
<div id="einsumindl3_W_kq" class="eq-elem">$${W_{k}}^{q}$$</div>
...
<div id="einsumindl4_T_ntkm" class="eq-elem">$${T_{ntm}}^{k}$$</div>
<div id="einsumindl4_W_kq" class="eq-elem">$${W_{k}}^{q}$$</div>
...
<div id="einsumindl6_A_ij" class="eq-elem">$${A_{i}}^{j}$$</div>
...
<div id="einsumindl7_A_ij" class="eq-elem">$${A_{i}}^{j}$$</div>
...
<div id="einsumindl8_A_ij" class="eq-elem">$${A_{i}}^{j}$$</div>
...
<div id="einsumindl9_A_ik" class="eq-elem">$${A_{i}}^{k}$$</div>
<div id="einsumindl9_b_k" class="eq-elem">$$b_{k}$$</div>
...
<div id="einsumindl10_A_ik" class="eq-elem">$${A_{i}}^{k}$$</div>
<div id="einsumindl10_B_kj" class="eq-elem">$${B_{k}}^{j}$$</div>
...
<div id="einsumindl11_eq" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl11_a_i" class="eq-elem">$$a^{i}$$</div>
<div id="einsumindl11_b_i" class="eq-elem">$$b_{i}$$</div>
<div id="einsumindl11_c" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}c$$</div>
</div>
...
<div id="einsumindl12_eq" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl12_A_ij" class="eq-elem">$${A_{i}}^{j}$$</div>
<div id="einsumindl12_B_ij" class="eq-elem">$${B_{j}}^{i}$$</div>
<div id="einsumindl12_c" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}c$$</div>
</div>
...
<div id="einsumindl13_eq2" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl13_A_ij" class="eq-elem">$${A^{i}}_{j}$$</div>
<div id="einsumindl13_B_ij" class="eq-elem">$${B^{j}}_{i}$$</div>
<div id="einsumindl13_C_ij" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}C_{ij}$$</div>
</div>
...
const tensors_einsumindl13 = [
  ...
  { x: 2, y: 0, name: "B", idEqPart: "einsumindl13_B_ij" },
];
...
drawDiagram(tensors_einsumindl13, contractions_einsumindl13, "einsumindl13", 220, 120);
...
<div id="einsumindl14_eq1" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl14_a_i" class="eq-elem">$$a_{i}$$</div>
<div id="einsumindl14_b_j" class="eq-elem">$$b_{j}$$</div>
<div id="einsumindl14_eq2" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
...
drawDiagram(tensors_einsumindl14_r, contractions_einsumindl14_r, "einsumindl14_r", 160, 120, 2);
...
<div id="einsumindl15_eq" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl15_A_ijk" class="eq-elem">$${A^{ij}}_{k}$$</div>
<div id="einsumindl15_B_ikl" class="eq-elem">$${B^{k}}_{il}$$</div>
<div id="einsumindl15_C_ijl" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}C_{ijl}$$</div>
</div>
...
const contractions_einsumindl15 = [
	{ source: 0, target: "left", name: "i" },
	{ source: 0, target: "down", name: "j" },
  { source: 0, target: 1, name: "k" },
  { source: 1, target: "down", name: "i" },
  { source: 1, target: "right", name: "l" },
];
...
<div id="einsumindl16_eq" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl16_A_pqrs" class="eq-elem">$${A^{ps}}_{qr}$$</div>
<div id="einsumindl16_B_tuqvr" class="eq-elem">$${B^{qr}}_{tuv}$$</div>
<div id="einsumindl16_C_pstuv" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}C_{pstuv}$$</div>
</div>

```{js, results='asis', echo=FALSE, message=FALSE}

const tensors_einsumindl16 = [
  { x: 1, y: 0, name: "A", idEqPart: "einsumindl16_A_pqrs", labPos: "leftup" },
  { x: 2, y: 0, name: "B", idEqPart: "einsumindl16_B_tuqvr", labPos: "leftup" },
];

const contractions_einsumindl16 = [
	{ source: 0, target: "left", name: "p" },
	{ source: 0, target: "up", name: "s" },
  { source: 0, target: 1, name: "q" },
  { source: 0, target: 1, name: "r" },
  { source: 1, target: "down", name: "t" },
  { source: 1, target: "right", name: "u" },
  { source: 1, target: "up", name: "v" },
];

drawDiagram(tensors_einsumindl16, contractions_einsumindl16, "einsumindl16", 220, 140);
...
<div id="einsumindl17_eq" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}$$</div>
<div id="einsumindl17_A_ik" class="eq-elem">$${A^{i}}_{k}$$</div>
<div id="einsumindl17_B_jkl" class="eq-elem">$${B^{k}}_{jl}$$</div>
<div id="einsumindl17_C_il" class="eq-elem">$$C^{il}$$</div>
<div id="einsumindl17_D_ij" class="eq-elem">$$\hspace{0.3cm}=\hspace{0.3cm}D_{ij}$$</div>
</div>
...
const contractions_einsumindl17 = [
	{ source: 0, target: "left", name: "i" },
  { source: 0, target: 1, name: "k" },
  { source: 1, target: "down", name: "j" },
  { source: 1, target: 2, name: "l" },
  { source: 2, target: "right", name: "i" },
];
