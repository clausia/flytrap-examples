...
<div id="einsumindl1_sum_ik" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{ik}$$</div>
<div id="einsumindl1_M_A" class="eq-elem">$$A_{ik}$$</div>
<div id="einsumindl1_M_B" class="eq-elem">$$B_{kj}$$</div>
<div id="einsumindl1_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl1_M_A" class="eq-elem">$${A^{i}}_{k}$$</div>
<div id="einsumindl1_M_B" class="eq-elem">$${B^{k}}_{j}$$</div>
<div id="einsumindl1_c_j" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}c_{j}$$</div>
</div>

```{js, results='asis', echo=FALSE, message=FALSE}

const tensors_einsumindl1 = [
  { x: 1, y: 0, name: "A", idEqPart: "einsumindl1_M_A" },
  { x: 2, y: 0, name: "B", idEqPart: "einsumindl1_M_B" },
];
...
<div id="einsumindl2_sum_i" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{i}$$</div>
<div id="einsumindl2_a_i" class="eq-elem">$$a_{i}$$</div>
<div id="einsumindl2_b_i" class="eq-elem">$$b_{i}$$</div>
<div id="einsumindl2_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl2_a_i" class="eq-elem">$$a_{i}$$</div>
<div id="einsumindl2_b_i" class="eq-elem">$$b^{i}$$</div>
<div id="einsumindl2_c" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}c$$</div>
</div>
...
<div id="einsumindl3_sum_k" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{k}$$</div>
<div id="einsumindl3_T_ntk" class="eq-elem">$$T_{ntk}$$</div>
<div id="einsumindl3_W_kq" class="eq-elem">$$W_{kq}$$</div>
<div id="einsumindl3_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl3_T_ntk" class="eq-elem">$${T^{nt}}_{k}$$</div>
<div id="einsumindl3_W_kq" class="eq-elem">$${W^{k}}_{q}$$</div>
<div id="einsumindl3_C_ntq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}C_{ntq}$$</div>
</div>
...
<div id="einsumindl4_sum_tk" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{tk}$$</div>
<div id="einsumindl4_T_ntkm" class="eq-elem">$$T_{ntkm}$$</div>
<div id="einsumindl4_W_kq" class="eq-elem">$$W_{kq}$$</div>
<div id="einsumindl4_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl4_T_ntkm" class="eq-elem">$${T^{ntm}}_{k}$$</div>
<div id="einsumindl4_W_kq" class="eq-elem">$${W^{k}}_{q}$$</div>
<div id="einsumindl4_C_mqn" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}C_{mqn}$$</div>
</div>
...
<div id="einsumindl5_eq1" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl5_2" class="eq-diagram"></div>
<div id="einsumindl5_right" class="eq-elem">$$\hspace{0.5cm}\rightarrow\hspace{0.5cm}$$</div>
<div id="einsumindl5_B_ji" class="eq-elem">$$B_{ji}$$</div>
<div id="einsumindl5_eq2" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
...
<div id="einsumindl6_sum_ij" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{ij}$$</div>
<div id="einsumindl6_M_A" class="eq-elem">$$A_{ij}$$</div>
<div id="einsumindl6_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl6_M_A" class="eq-elem">$$A_{ij}$$</div>
<div id="einsumindl6_b" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}b$$</div>
</div>

```{js, results='asis', echo=FALSE, message=FALSE}

const tensors_einsumindl6 = [
  { x: 1, y: 0, name: "A", idEqPart: "einsumindl6_M_A" },
];
...
drawDiagram(tensors_einsumindl6, contractions_einsumindl6, "einsumindl6", 160, 120, 2);
...
<div id="einsumindl7_sum_i" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{i}$$</div>
<div id="einsumindl7_M_A" class="eq-elem">$$A_{ij}$$</div>
<div id="einsumindl7_eq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}$$</div>
<div id="einsumindl7_M_A" class="eq-elem">$$A_{ij}$$</div>
<div id="einsumindl7_b_j" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}b_{j}$$</div>
</div>

```{js, results='asis', echo=FALSE, message=FALSE}

const tensors_einsumindl7 = [
  { x: 1, y: 0, name: "A", idEqPart: "einsumindl7_M_A" },
];
...
drawDiagram(tensors_einsumindl7, contractions_einsumindl7, "einsumindl7", 160, 120, 2);
