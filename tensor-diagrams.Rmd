...
const contractions_einsumindl12 = [
    ...
    //{ source: 1, target: 0, name: "i" }, //not yet working
];
...
const contractions_einsumindl13 = [
    { source: 0, target: 1, name: "j" }, //check this case!!
];
...
const tensors_einsumindl16 = [
    { x: 1, y: 0, name: "A", idEqPart: "einsumindl16_A_pqrs", labPos: "leftup", shape: "rectangle",
        indices: [
            { pos: "left", name: "p" },
            { pos: "right", name: "q" },
            { pos: "right", name: "r" },
    ...
    { x: 2, y: 0, name: "B", idEqPart: "einsumindl16_B_tuqvr", labPos: "leftup", //this is also a rectangle, but down index dont work yet
        indices: [
            { pos: "left", name: "q" },
            { pos: "left", name: "r" },
            { pos: "down", name: "t" },
