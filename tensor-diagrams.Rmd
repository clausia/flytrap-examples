...
<div id="einsum1_M_A" class="eq-elem">$${A^{i}}_{k}$$</div>
<div id="einsum1_M_B" class="eq-elem">$${B^{k}}_{j}$$</div>
</div>
...
<div id="einsum2_a_i" class="eq-elem">$$a_{i}$$</div>
<div id="einsum2_b_i" class="eq-elem">$$b^{i}$$</div>
</div>
...
<div id="einsum3_T_ntk" class="eq-elem">$${T^{nt}}_{k}$$</div>
<div id="einsum3_W_kq" class="eq-elem">$${W^{k}}_{q}$$</div>
</div>
...
<div id="einsum4_C_mqn" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{k}$$</div>
...
<div id="einsum4_T_ntkm" class="eq-elem">$${T^{ntm}}_{k}$$</div>
<div id="einsum4_W_kq" class="eq-elem">$${W^{k}}_{q}$$</div>
</div>

```{js, results='asis', echo=FALSE, message=FALSE}

const tensors_einsum4 = [
  { x: 1, y: 0, name: "T", idEqPart: "einsum4_T_ntkm", labPos: "left" },
...
drawDiagram(tensors_einsum4, contractions_einsum4, "einsum4", 220, 140);
