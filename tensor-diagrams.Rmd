...
<div id="einsumindl1_c_j" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{k}$$</div>
...
drawDiagram(tensors_einsumindl1, contractions_einsumindl1, "einsumindl1", 220, 115);
...
<div id="einsumindl2_c" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{i}$$</div>
...
drawDiagram(tensors_einsumindl2, contractions_einsumindl2, "einsumindl2", 100, 115);
...
<div id="einsumindl3_C_ntq" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{k}$$</div>
...
<div id="einsumindl4_C_mqn" class="eq-elem">$$\hspace{0.5cm}=\hspace{0.5cm}\sum_{k}$$</div>
...
const tensors_einsumindl4 = [
  { x: 1, y: 0, name: "T", idEqPart: "einsumindl4_T_ntkm", labPos: "left" },
...
drawDiagram(tensors_einsumindl5_1, contractions_einsumindl5_1, "einsumindl5_1", 160, 115, 1);
drawDiagram(tensors_einsumindl5_2, contractions_einsumindl5_2, "einsumindl5_2", 160, 115, 2);
