...
Therefore, it is possible to define a state using $\theta$ and $\phi$ which correspond to the definition of the Bloch sphere as follows:
...
You can test for yourself the effect of the different gates, simply drag the gate you want to apply to the *selected gates* area, to delete a gate from that area click on it (double tap on mobile).
