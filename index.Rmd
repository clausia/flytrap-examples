...
The following example applies the gates $Z$, $H$, $X$, $Z$, $Y$ (in that order).
...
new Vue({
  ...
  data() {
      ...
      stepsQuantumComputing: [
        ...
        { value: 'Apply Z gate', vector: circuitHistoryBig[4].vector },
        { value: 'Apply Y gate', vector: circuitHistoryBig[5].vector },
      ],
	  }
  }
})
