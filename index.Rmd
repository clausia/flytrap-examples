  ...
  for (i = gates.length - 1; i >= 0; i--) {
    switch(gates[i].name) {
      ...
      case 'H':
        ...
        break;
      case 'I':
        circ.applyGate(Gates.I(), [0]).saveTo(circuitHistoryBig2);
        break;
      case 'S':
        circ.applyGate(Gates.S(), [0]).saveTo(circuitHistoryBig2);
        break;
      case 'T':
        circ.applyGate(Gates.T(), [0]).saveTo(circuitHistoryBig2);
        break;
      default:
        // default case
    }
