...
Quantum gates can be composed. In a conventional matrix notation, we read from right to left. That is, $X \;H \; Z \; |0\rangle$ means that we start with state $|0\rangle$, then apply $Z$ gate, then $H$, then $X$. It is a historic notation that is going to stay here. While in quantum circuits we use a typical left to right notation, for the sake of this visualizaiton we use the matrix notation.
