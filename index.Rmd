...
Observe how the state changes according to the applied gates. In BraKetVue, we use [colors to denote phase of complex numbers](https://en.wikipedia.org/wiki/Domain_coloring)[@DomainColoring20] [@Migdal14] and [@Qubism20] from an implementation for [QuTiP](http://qutip.org/).
